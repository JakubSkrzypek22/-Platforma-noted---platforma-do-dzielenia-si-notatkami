...
class NoteController extends Controller
{
    ...
    public function show(Request $request, Note $note)
    {
        ...
        // Wyświetlenie liczymy raz na sesję (odświeżenie nie zwiększa licznika)
        // i pomijamy autora oglądającego własną notatkę.
    ...
    /**
     * Buduje rozmyty obraz przykładowy (SVG) dla gości. Treść jest sztuczna i mocno rozmyta
     * filtrem feGaussianBlur — nie zawiera prawdziwej zawartości notatki, więc nie da się jej
     * odsłonić, usuwając style CSS po stronie przeglądarki.
     */
    /**
