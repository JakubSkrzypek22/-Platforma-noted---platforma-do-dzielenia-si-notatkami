...
<div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        ...
        <p class="text-slate-400">Przeglądaj najlepsze materiały naukowe.</p>
    </div>
    ...
    <button onclick="document.getElementById('add-trip-modal').classList.remove('hidden')" class="px-5 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white rounded-xl font-medium shadow-lg transition-all duration-300 hover:scale-105 flex items-center">
        <i class="fa-solid fa-plus mr-2"></i> Wystaw Notatkę
    </button>
    @endif
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div class="glass rounded-2xl overflow-hidden border border-slate-700/50 group hover:-translate-y-1 transition-all duration-300 hover:shadow-[0_10px_30px_rgba(0,0,0,0.3)]">
        ...
        <div class="p-6">
            <h3 class="text-xl font-bold text-white mb-2 line-clamp-1">{{ $trip->name }}</h3>
            ...
            <div class="flex items-center text-sm text-slate-300 mb-6">
                ...
                <div class="flex items-center">
                    ...
                    <span class="font-medium mr-2">Sprzedawca</span>
                    <span class="text-yellow-400 text-xs">★★★★<span class="text-slate-500">★</span></span>
                    <span class="ml-1 text-xs text-slate-500">(12 opinii)</span>
                </div>
            </div>
            
            <div class="flex items-center justify-between pt-4 border-t border-slate-800">
                <div>
                    <span class="text-xs text-slate-400 block">Cena</span>
    ...
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-lg">
        <div class="glass rounded-2xl p-6 md:p-8 shadow-2xl border border-slate-700 m-4 max-h-[90vh] overflow-y-auto">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-bold text-white">Wystaw Notatkę</h3>
            ...
            <form action="{{ route('trips.store') }}" method="POST" class="space-y-4">
                @csrf
                <div>
                    <label class="block text-sm text-slate-300 mb-1">Tytuł Materiału</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm text-slate-300 mb-1">Przedmiot</label>
                    ...
                    <div>
                        <label class="block text-sm text-slate-300 mb-1">Stron/Rozmiar</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm text-slate-300 mb-1">Wydział ID</label>
                    ...
                    <div>
                        <label class="block text-sm text-slate-300 mb-1">Cena (zł)</label>
                ...
                <div>
                    <label class="block text-sm text-slate-300 mb-1">Opis (czytelność, zakres)</label>
                ...
                <div>
                    <label class="block text-sm text-slate-300 mb-1">Obrazek</label>
