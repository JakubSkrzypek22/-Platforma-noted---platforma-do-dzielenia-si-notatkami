@include('shared.html')
@include('shared.head', ['pageTitle' => 'Notet — Drugie Życie Twoich Notatek 📚'])

<body class="d-flex flex-col min-vh-100 bg-body-tertiary">
    ...
    <main class="flex-grow-1 py-5">
        <div class="container">
            ...
            <div class="tab-content" id="notetTabsContent">
                ...
                <!-- TAB 1: STRONA GŁÓWNA (Główny widok platformy) -->
                <div class="tab-pane fade show active" id="home-pane" role="tabpanel" aria-labelledby="home-tab">
                    
                    <!-- Premium Jumbotron Welcome Hero Section -->
                    <div class="p-5 mb-4 rounded-4 hero-banner shadow-lg text-white">
                        <div class="container-fluid py-5">
                            <span class="badge bg-white text-primary fw-bold px-3 py-2 mb-3 rounded-pill text-uppercase tracking-wider">Nowa Era Nauki</span>
                            <h1 class="display-4 fw-extrabold mb-3">Witaj w Notet</h1>
                            <p class="col-md-8 fs-4 mb-4">Pierwszej, w pełni cyfrowej i zoptymalizowanej giełdzie notatek studenckich działającej w duchu ekonomii współdzielenia. Pomóż innym w nauce i zacznij zarabiać na swojej akademickiej wiedzy!</p>
                            <div class="d-flex flex-wrap gap-3">
                                <button class="btn btn-light btn-lg px-4 fw-bold text-primary" onclick="switchTabDirect('idea-tab')">💡 Poznaj Ideę</button>
                                <button class="btn btn-outline-light btn-lg px-4" onclick="switchTabDirect('basket-tab')">🛍️ Zarządzaj Koszykiem</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="card premium-card h-100 p-4">
                                <div class="w-12 h-12 rounded-3 bg-primary bg-opacity-10 d-flex align-items-center justify-content-center text-primary mb-3" style="width: 48px; height: 48px;">
                                    <i class="bi bi-upload fs-3"></i>
                                </div>
                                <h3 class="h4 fw-bold">1. Wgraj Opracowania</h3>
                                <p class="text-secondary mb-0">Udostępniaj swoje staranne wykłady, precyzyjne schematy i skróty lektur. Nadaj im odpowiedni opis, kategorię oraz ustal preferowaną cenę.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card premium-card h-100 p-4">
                                ...
                                <h3 class="h4 fw-bold">2. Społeczna Weryfikacja</h3>
                                <p class="text-secondary mb-0">Przeglądaj notatki ocenione przez innych studentów. System recenzji społecznościowych i gwiazdek precyzyjnie promuje najbardziej merytoryczne prace.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card premium-card h-100 p-4">
                                ...
                                <h3 class="h4 fw-bold">3. Zarabiaj i Oszczędzaj</h3>
                                <p class="text-secondary mb-0">Odbieraj natychmiastowe mikro-płatności bezpośrednio na swoje konto za pobrania Twoich prac lub oszczędzaj tygodnie nauki dzięki genialnym streszczeniom.</p>
                            </div>
                        </div>
                    </div>

                    <!-- Current Code Placeholder Area -->
                    <div class="border border-2 border-dashed border-primary border-opacity-25 rounded-4 p-5 bg-body-secondary bg-opacity-50 text-center shadow-sm">
                        <i class="bi bi-code-square text-primary display-4 mb-3"></i>
                        <h4 class="fw-bold">Miejsce na Twój obecny kod pętli</h4>
                        <p class="text-secondary mx-auto" style="max-width: 600px;">
                            Poniższa sekcja została przygotowana jako wydzielony placeholder. Możesz tu swobodnie wstrzyknąć swój istniejący kod pętli Blade do renderowania ofert bazy danych, formularzy wyszukiwania lub innych widoków Laravel.
                        </p>
                        <div class="my-4">
                            <code class="d-block p-3 rounded-3 bg-dark text-success text-start shadow" style="max-width: 550px; margin: 0 auto; font-family: monospace;">
                                <span class="text-secondary">&lt;!-- Miejsce na Twój obecny kod --&gt;</span><br>
                                @<span>foreach ($notatki as $notatka)</span><br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&lt;div class="custom-card"&gt;<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<span>{ $notatka->title }</span>}<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
                ...
                <div class="tab-pane fade" id="idea-pane" role="tabpanel" aria-labelledby="idea-tab">
                    <div class="editorial-wrapper py-3">
                        ...
                        <div class="text-center mb-5">
                            ...
                            <h2 class="display-5 fw-bold mt-2">Ekosystem Cyfrowej Synergii Akademickiej</h2>
                        ...
                        <div class="row g-5 align-items-center mb-5">
                            <div class="col-md-7">
                                <h3 class="fw-bold mb-3">Nowy Wymiar Dzielenia Się Wiedzą</h3>
                        ...
                        <!-- Rich Cards Grid -->
                        <h3 class="fw-bold text-center mb-4">Trzy Filary Naszej Architektury Ideowej</h3>
                        <div class="row g-4 mb-5">
                            <div class="col-md-4">
                                <div class="card premium-card h-100 p-4">
                        ...
                        <h3 class="fw-bold text-center mb-4">Innowacja Technologiczna i Rozwój</h3>
                ...
                <div class="tab-pane fade" id="basket-pane" role="tabpanel" aria-labelledby="basket-tab">
                    ...
                    <div class="row g-4">
                        ...
                        <!-- Left Panel: Create Form Card (Sticky) -->
                        <div class="col-lg-4">
                            <div class="card premium-card p-4 shadow-sm position-sticky" style="top: 100px;">
                                ...
                                <form id="note-form" onsubmit="handleCreateNote(event)">
                                    <div class="mb-3">
                                        <label for="form-title" class="form-label small fw-bold">Tytuł Opracowania</label>
                                        <input type="text" class="form-control" id="form-title" placeholder="np. Analiza Matematyczna - Całki" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="form-content" class="form-label small fw-bold">Treść / Opis Notatek</label>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-6">
                                            <label for="form-price" class="form-label small fw-bold">Cena (PLN)</label>
                                            <input type="number" class="form-control" id="form-price" step="0.01" min="0" placeholder="0.00" required>
                                        </div>
                                        <div class="col-6">
                                            <label for="form-status" class="form-label small fw-bold">Status</label>
                                    ...
                                    <div class="mb-4 form-check">
                                        ...
                                        <label class="form-check-label small fw-bold" for="form-favorite">Dodaj do ulubionych (❤️)</label>
                                    </div>
                                    <button type="submit" class="btn btn-primary w-full py-2.5 fw-bold shadow d-flex align-items-center justify-content-center">
                            ...
                            <div class="card premium-card p-3 mb-4 shadow-sm">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-7 text-md-end">
                                        <div class="d-flex flex-wrap gap-1.5 justify-content-md-end" id="filter-pills-container">
                ...
                container.innerHTML = `
                    <div class="col-12">
                        <div class="empty-state shadow-sm">
                            ...
                            <h4 class="fw-bold">Brak Pasujących Materiałów</h4>
                ...
                if (isEditing) {
                    ...
                    col.innerHTML = `
                        <div class="card premium-card p-4 shadow-sm border-primary">
                            <div class="mb-3">
                                <label class="form-label small fw-bold">Tytuł Opracowania</label>
                        ...
                        <div class="card premium-card h-100 d-flex flex-column justify-content-between p-4 shadow-sm">
                            <div>
                                <div class="d-flex justify-content-between align-items-start gap-2 mb-3">
                                    <h4 class="h5 fw-bold mb-0 text-break" style="line-height: 1.4;">${escapeHtml(note.title)}</h4>
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-3 pt-2">
                                    <button class="btn btn-sm btn-light border d-flex align-items-center" onclick="startInlineEdit(${note.id})">
