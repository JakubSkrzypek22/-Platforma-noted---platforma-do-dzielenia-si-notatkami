...
(function () {
  ...
  const QUESTIONS = [
    ...
    {
      id: 'register',
      label: '👤 Jak założyć konto?',
      answer: 'Rejestracja jest bezpłatna i zajmuje chwilę. Kliknij "Zarejestruj się" w prawym górnym rogu nawigacji!',
      tourSteps: [
        {
          element: 'nav',
          popover: {
            title: '🔝 Nawigacja',
            description: 'W prawym górnym rogu znajdziesz przyciski do logowania i rejestracji.',
            side: 'bottom',
            align: 'end',
          },
        },
    ...
    {
      id: 'buy-notes',
      label: '🛒 Jak kupić notatki?',
      answer: 'Kliknij w dowolną notatkę z katalogu, sprawdź podgląd i kliknij "Kup" lub "Pobierz za darmo". Bezpieczna płatność przez Stripe!',
      tourSteps: [
        {
          element: '#notesGrid',
          popover: {
            title: '📚 Wybierz notatkę',
            description: 'Przeglądaj katalog — każda karta pokazuje cenę, ocenę i autora. Kliknij "Zobacz / Pobierz PDF" aby przejść do szczegółów.',
            side: 'top',
            align: 'center',
          },
        },
